export type VariantTypes = {
  ...
  "breadcrumbs": [];
  "button": ["colors", "customize", "disabled", "loading", "radius", "sizes", "usage", "variants-colors", "variants", "with-icons", "without-effects"];
  "card": ["radius", "start-end-content", "usage", "variants", "with-divider", "with-form"];
  "charts": [];
  ...
  "empty-content": [];
  "file-upload-multi": ["controlled", "customized", "default-value", "disabled", "radius", "usage"];
  "file-upload-single": ["avatar", "controlled", "customized", "default-value", "disabled", "horizontal", "radius", "usage"];
  ...
  "input": ["bordered-all-props", "clearable", "controlled", "disabled", "error-state", "filled", "helper-text", "horizontal", "label-helper", "numbers-only", "outlined-all-props", "placeholder", "radius", "required-optional", "secured-text", "sizes", "standard-all-props", "start-end-content", "underlined-all-props", "usage", "variants", "with-icon", "with-placeholder", "without-label"];
  ...
  "radio": ["checked", "colors", "disabled", "invalid", "radio-group-controlled", "radio-group-custom", "radio-group-horizontal", "radio-group", "sizes", "usage"];
  ...
  "ripple": ["center", "usage"];
  "select": ["controlled", "custom-render-complex", "custom-render-multi-search", "custom-render-multi", "custom-render-value", "disabled-items", "disabled", "horizontal", "invalid-state", "multiple-controlled", "multiple", "placeholder", "radius", "sizes", "start-end-items", "usage", "with-helper-text", "without-label"];
  ...
  "text": ["all", "usage"];
  "textarea": ["controlled", "disabled", "error-state", "helper-text", "horizontal", "label-helper", "placeholder", "radius", "sizes", "usage", "variants", "with-end-content", "with-icon", "with-placeholder", "with-start-content", "without-label"];
  "toast": ["radius", "usage"];
  "tooltip": ["customized", "offset", "radius", "usage", "with-arrow"];
  ...
  "radial-bar-chart": ["radial-gauge", "radial-multi-bar", "radial-semi-circle-gauge", "radial-simple"];
