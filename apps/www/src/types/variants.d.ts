export type VariantTypes = {
  ...
  "file-upload-single": ["avatar", "controlled", "customized", "default-value", "disabled", "usage"];
  ...
  "ripple": ["center", "usage"];
  "select": ["controlled", "custom-render-complex", "custom-render-multi", "custom-render-value", "disabled", "invalid-state", "multiple-controlled", "multiple", "placeholder", "sizes", "start-end-items", "usage", "with-helper-text", "without-label"];
  "show": ["usage"];
  "skeleton": ["usage"];
  "slider": [];
