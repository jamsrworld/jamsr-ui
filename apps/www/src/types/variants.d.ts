export type VariantTypes = {
  ...
  "chip": ["colors", "radius", "sizes", "usage", "variants-colors", "variants", "with-delete"];
  ...
  "menu": ["backdrop", "controlled", "customize", "nested", "offset", "placement", "prevent-close", "radius", "start-end-content", "trigger-on-hover", "usage", "with-arrow", "without-lock-scroll"];
  "number-input": [];
